...
// in simulator we redefine to format for Kostervandring Developer console
...
{\
	NSString * exceptionName = [@"org.kostervandring." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.kostervandring";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIKostervandringNativeItemNone = -1, 
	UIKostervandringNativeItemSpinner = -2,
	UIKostervandringNativeItemProgressBar = -3,
	
	UIKostervandringNativeItemSlider = -4,
	UIKostervandringNativeItemSwitch = -5,
	UIKostervandringNativeItemMultiButton = -6,
	UIKostervandringNativeItemSegmented = -7,
	
	UIKostervandringNativeItemTextView = -8,
	UIKostervandringNativeItemTextField = -9,
	UIKostervandringNativeItemSearchBar = -10,
	
	UIKostervandringNativeItemPicker = -11,
	UIKostervandringNativeItemDatePicker = -12,
	
	UIKostervandringNativeItemInfoLight = -13,
	UIKostervandringNativeItemInfoDark = -14,
	
	UIKostervandringNativeItemDisclosure = -15,
	
	UIKostervandringNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Kostervandring instances of
