...
/**
 Base class for all Kostervandring views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Kostervandring view hierarchy (such as wrapped iOS UIViews) was touched.
