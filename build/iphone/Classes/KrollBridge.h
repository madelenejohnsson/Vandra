...
@interface KostervandringObject : KrollCoverageObject {
#else
@interface KostervandringObject : KrollObject {
#endif
@private
...
extern NSString * Kostervandring$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	KostervandringObject *_kostervandring;
    KrollObject* console;
	BOOL shutdown;
