...
//@interface KostervandringObject : NSObject
//@end

@interface KostervandringObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KostervandringObject class]])
		{
			for (NSString *key in [[(KostervandringObject*)o modules] allKeys])
			{
