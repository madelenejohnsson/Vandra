...
//Rare exceptions to indicate a bug in the _kostervandring code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Kostervandring proxies.
 */
